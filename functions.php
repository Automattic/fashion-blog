...
if ( ! function_exists( 'fashion_blog_setup' ) ) :
	...
	function fashion_blog_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'fashion-blog' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'fashion_blog_custom_background_args', array(
...
add_action( 'after_setup_theme', 'fashion_blog_setup' );
 ...
 */
function fashion_blog_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'fashion-blog' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'fashion-blog' ),
...
add_action( 'widgets_init', 'fashion_blog_widgets_init' );

/**
 * Google Fonts
 */

function fashion_blog_fonts_url() {
	$fonts_url = '';
